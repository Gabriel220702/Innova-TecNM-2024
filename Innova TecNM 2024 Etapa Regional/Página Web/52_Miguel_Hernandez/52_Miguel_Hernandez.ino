...
const char *ssid = "Vivo Y01";//                                   "INFINITUM86C2";          "Redmi Note 13";
const char *password = "00000000"; //                                   "ELd4TfVbHW";             "22072207";
...
String token = "Bearer EAAHVsVqyt4UBOy1Vvm8e6spniNkZAuJIEkBZCTf9EtYZB1vUfLZBwkX6h27JOJGD4y56XbrjJOoE848AcHm6Dc7Tj22A8zyYUJtWOLUGnC2hhIazaqO4RQRvYRDn1j6AHGomnNVcSJRlbuBdpKt0fLZBldvUdFPgfKyjdTEbd5MM4dbZCvOOWwZCDcTpMYMEOr8JgZDZD";
String servidor = "https://graph.facebook.com/v19.0/345081398691756/messages";

// Configuración del id del dispositivo
String idDispositivo = "52"; // Miguel_Hernandez
...
bool enviarDatos(String posicionCaida) {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    HTTPClient http;
    http.begin("https://home.amoxtli-jap.com/php/recibir_datos.php"); // URL local del archivo PHP
    ...
    String payloadWhatsApp = "{\"messaging_product\":\"whatsapp\",\"to\":\"528143865808\",\"type\":\"text\",\"text\":{\"body\":\"¡Alerta de caída! Hemos detectado que el Sr. Sifuentes  ha sufrido una caída. Ingresa a este enlace inmediatamente para obtener información y auxiliar a tu familiar: https://home.amoxtli-jap.com/SignIn_SignUp/SignIn.php\"}}";
...
String obtenerNombrePosicion(Posicion posicion) {
  switch (posicion) {
    ...
    case Posicion::BocaArriba:
      return "Posicionado Boca Arriba";
    case Posicion::BocaAbajo:
      return "Posicionado Boca Abajo";
    case Posicion::LadoIzquierdo:
      return "Posicionado sobre su Lado Izquierdo";
    case Posicion::LadoDerecho:
      return "Posicionado sobre su Lado Derecho";
    default:
      return "Desconocida";
  }
}
