...
#menu {
    padding: 0.5px 0;
    background-color: rgb(162, 73, 197); /* Color del fondo del menú */
...
#menu .navbar-nav > li > a:hover {
    color: #25e0d0; /* Color del texto de los enlaces al pasar el cursor */
}
...
.navbar-toggler:hover, .navbar-toggler:focus {
    background-color: #25e0d0; /* Color de fondo del botón de alternancia */
