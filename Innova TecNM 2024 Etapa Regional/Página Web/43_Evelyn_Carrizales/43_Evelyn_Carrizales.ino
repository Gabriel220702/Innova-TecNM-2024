...
String token = "Bearer EAATZBnzifrNABO3HXoujzYT61q90p3Y7TFprO69F9H4ZCZBTJTNZAVTxrrEOb8YltHsI8mJPD5egfsXZCZAwxK5MZAg5PamZB9btNLtswMzjq8uI7AdpKw0ML2MtVIQcsDZCKSgiawrDpsryMEEMkZBgYKId5xPMuqtorzong3DHXYmxCO2JtLsDUH3ZCUdcaBaNZAtV6gZDZD";
String servidor = "https://graph.facebook.com/v19.0/345081398691756/messages";

// Configuración del id del dispositivo 
String idDispositivo = "43"; // Evelyn_Carrizales
...
bool enviarDatos(String posicionCaida) {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    HTTPClient http;
    http.begin("https://home.amoxtli-jap.com/php/recibir_datos.php"); // URL Amoxtli-Jap
    ...
    String payloadWhatsApp = "{\"messaging_product\":\"whatsapp\",\"to\":\"526761055593\",\"type\":\"text\",\"text\":{\"body\":\"¡Alerta de caída! Hemos detectado que Evelyn ha sufrido una caída. Ingresa a este enlace inmediatamente para obtener información y auxiliar a tu familiar: https://home.amoxtli-jap.com/SignIn_SignUp/SignIn.php\"}}";
