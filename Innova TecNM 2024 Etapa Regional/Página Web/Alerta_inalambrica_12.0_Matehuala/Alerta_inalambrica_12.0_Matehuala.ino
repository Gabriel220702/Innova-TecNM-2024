...
const char *ssid = "HOME-2C6C";
const char *password = "A97F71BC4A2E9F75";
const char *host = "10.0.0.23"; // IP local de tu computadora
...
bool enviarDatos(String posicionCaida) {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    HTTPClient http;
    http.begin("http://10.0.0.23/Amoxtli_Jap/php/recibir_datos.php"); // URL local del archivo PHP
    ...
    String payloadWhatsApp = "{\"messaging_product\":\"whatsapp\",\"to\":\"526761055560\",\"type\":\"text\",\"text\":{\"body\":\"¡Alerta de caída! Hemos detectado que Gabriel ha sufrido una caída. Ingresa a este enlace inmediatamente para obtener información y auxiliar a tu familiar: http://10.0.0.23/Amoxtli_Jap/formulario.php\"}}";
