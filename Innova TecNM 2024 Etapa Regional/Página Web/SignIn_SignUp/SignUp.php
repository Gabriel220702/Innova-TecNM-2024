...
if (isset($_SESSION['Email_Session'])) {
    ...
    exit();  // Cambié die() por exit() para mayor legibilidad
}
include('config.php');
    ...
    if (empty($name) || empty($email) || empty($password) || empty($confirm_password)) {
        ...
        if ($result->num_rows > 0) {
            ...
            if ($result->num_rows > 0) {
                ...
                $stmt = $conx->prepare("INSERT INTO register (Username, email, Password) VALUES (?, ?, ?)");
                $stmt->bind_param("sss", $name, $email, $password_hash);

                if ($stmt->execute()) {
                    $msg = "<div class='alert alert-info'>Registro exitoso. Ahora puedes iniciar sesión.</div>";
                } else {
    ...
    <div class="container sign-up-mode">
        ...
        <div class="panels-container">
            ...
            <div class="panel right-panel">
                <div class="content">
                    <h3>¿Ya eres parte de Amoxtli-Jap?</h3>
                ...
                <img src="img/Compu.png" class="image" alt="" />
            </div>
        </div>
    </div>
</body>
