...
const char *ssid = "INFINITUM86C2"; //                                   "INFINITUM86C2";          "Redmi Note 13";         "Galaxy S20";
const char *password = "ELd4TfVbHW"; //                                   "ELd4TfVbHW";             "22072207";          "123456789";
...
String idDispositivo = "44"; // Gabriel_Carrizales
...
bool enviarDatos(String posicionCaida) {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    String payloadWhatsApp = "{\"messaging_product\":\"whatsapp\",\"to\":\"526761055560\",\"type\":\"text\",\"text\":{\"body\":\"¡Alerta de caída! Hemos detectado que Gabriel ha sufrido una caída. Ingresa a este enlace inmediatamente para obtener información y auxiliar a tu familiar: https://home.amoxtli-jap.com/SignIn_SignUp/SignIn.php\"}}";
